...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Blockerry`}</title>

        <meta
          name="description"
          content="Experience Blockerry - Your gateway to versatile services. Request, pay, subscribe, and start your service instantly with customized details. Blockerry - Service at the speed of thought."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518546305927-5a555bb7020d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcnlwdG9jdXJyZW5jeXxlbnwwfHx8fDE2OTk5NTI5OTR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Blockerry - Your gateway to versatile services. Request, pay, subscribe, and start your service instantly with customized details. Blockerry - Service at the speed of thought.`}
            </Text>
            <Box
